  ...
  return (
    <section className="flex justify-between items-center px-10 w-full h-20 bg-[#292929] border-b">
      <article className="flex h-12 w-12">
        <NavLink onClick={()=> setMobileMenu(!mobileMenu)} to='/'><img src={logo} className="rounded-full object-contain duration-300"/></NavLink>
      </article>
      ...
      <article className='hidden relative text-white text-3xl max-sm:flex'>
        ...
        <ul className={`${mobileMenu ? 'left-20 hidden' : 'left-[-110px]'} flex bg-[#292929] absolute flex-col text-2xl w-[180px] px-2 h-[50vh] top-[-20px] gap-10 justify-center items-center text-[#fafafa] z-20 rounded-md border duration-300`}>
