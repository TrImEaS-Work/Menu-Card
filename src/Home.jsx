...
export default function Home () {
  return (
    <section className="bg-[#111] text-[#fafafa] min-h-screen w-full flex flex-col justify-center items-center p-10 gap-10">
      <h1 className='font-semibold text-2xl'>Seleccione una carta para ver demo</h1>
      <article className="relative flex flex-col border-2 border-[#fafafa] w-3/4 max-sm:w-full max-w-[400px] rounded-sm h-[400px] max-sm:h-[300px]">
